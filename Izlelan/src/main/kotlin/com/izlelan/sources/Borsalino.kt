...
object Borsalino {
    private val workerUrl = BaseUrls.get("borsalino_api", "https://filmizlenet.ayruki.workers.dev")
            ...
            hlsObj.keys().forEach { rawLabel ->
                ...
                if (hlsUrl.isNotBlank()) {
                    ...
                    callback(
                        newExtractorLink(
                            source = "🇹🇷 Borsalino",
                            name = "🇹🇷 Borsalino [$label]",
                            url = hlsUrl,
                            type = ExtractorLinkType.M3U8
                        ) {
                            this.referer = "https://filmizlenet.org/"
                ...
                sourcesObj.keys().forEach { rawLabel ->
                    ...
                    if (sourceUrl.isNotBlank()) {
                        ...
                        val loaded = runCatching {
                            loadExtractor(sourceUrl, "https://filmizlenet.org/", subtitleCallback, callback)
                        }.getOrDefault(false)
